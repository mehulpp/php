...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE users set userName='" . $_POST["userName"] . "', password='" . $_POST["password"] . "', firstName='" . $_POST["firstName"] . "', lastName='" . $_POST["lastName"] . "' WHERE userId='" . $_POST["userId"] . "'");
...
<div align="right" style="padding-bottom:5px;"><a href="list_user.php" class="link">
