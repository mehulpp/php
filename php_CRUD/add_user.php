...
include 'db.php';
if(count($_POST)>0) {
mysqli_query($conn,"INSERT INTO users (userName, password, firstName, lastName) VALUES ('" . $_POST["userName"] . "','" . $_POST["password"] . "','" . $_POST["firstName"] . "','" . $_POST["lastName"] . "')");
...
<tr>
<td colspan="2"><input type="submit" id="sub" name="submit" value="Submit" class="btnSubmit"></td>
</tr>
</table>
</div>
</form>
